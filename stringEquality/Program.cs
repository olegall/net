...
namespace TestReferenceEquality
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            // Changes made to tcA are reflected in tcB. Therefore, objects that have reference equality also have value equality.
            tcA.Num = 42;
            ...
            // Value types are boxed into separate objects when passed to ReferenceEquals. TODO
            ...
            // After a new string is assigned to strA, strA and strB are no longer interned and no longer have reference equality
            strA = "Goodbye world!";
            Console.WriteLine($"strA = '{strA}' strB = '{strB}'");

            Console.WriteLine("After strA changes, ReferenceEquals(strA, strB) = {0}", Object.ReferenceEquals(strA, strB)); // false
