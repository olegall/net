...
internal class AsyncAwait
{
    ...
    async void TasksSync1()
    {
        ...
        //t1.Wait(); // TODO проверить. скорее всего эквивалентно await
        //t2.Wait();
        // результат не адекватный. самая долгая задача. в объявленных задачах нет авейта
        // оптимизация компилятора? зачем ждать задачу короче, если отработала задача длиннее 
        await t1; // 
        await t2;
        //await f1_();
        //await f2_();
